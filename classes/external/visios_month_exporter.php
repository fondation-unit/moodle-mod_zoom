...
use core_calendar\external\day_name_exporter;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class visios_month_exporter extends exporter {
    ...
    public function __construct(\calendar_information $calendar, \core_calendar\type_base $type, $related) {
        ...
        $this->url = new moodle_url('/local/meetings/index.php', [
                'view' => 'month',
                'time' => $calendar->time,
            ]);
    ...
    public function set_initialeventsloaded(bool $loaded) {
        $this->initialeventsloaded = false;
